...
pdf("../Figures/Whole_genome_subdivided.v2.pdf", width = 14, height = 6)
p
dev.off()
...
pdf("../Figures/Whole_genome_subdivided_FST.2.pdf", width = 10, height = 5)
p4
dev.off()
...
pdf("../Figures/Manhattan_WestvsEast.v2.pdf", height = 9, width = 9)
...
p1 = ggplot(temp,aes(color,
    ...
    stat_compare_means(aes(group = color),
                       ...
                       label = "p.signif") + scale_fill_manual(values = colors2) + theme(legend.position = "top", axis.text.x = element_blank(),axis.text.y = element_text(size = 12), axis.title.y = element_text(size = 18), strip.text = element_text(size = 18), legend.text = element_text(size = 12)) + facet_grid(~factor(variable2, levels = c("South Canterbury", "Selfe", "West")))
...
## GO enrichment analysis - Figure 3E

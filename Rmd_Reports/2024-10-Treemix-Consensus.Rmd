...
library(cowplot)
source("../../lausanne_postdoc/jokela_lab_info/Treemix/Tree_Space_Analysis_Consensus/plotting_funcs.R")

poolnames = read.csv("../../lausanne_postdoc/jokela_lab_info/Treemix/Tree_Space_Analysis_Consensus/pops.lst.txt", sep = " ", header = F)
...
treemixobj = read_treemix("../../lausanne_postdoc/jokela_lab_info/Treemix/whole_genome_split_out/random_sample_without_replacement_081")
```
...
pdf("../Figures/TreeMix_as_a_Map.pdf", height = 6, width = 6)
ggplot() +
    # subtle basemap
